...
function BeginRequestHandler(sender, args) {
    ...
    // var dvId = sender._postBackSettings.asyncTarget;
    // dvId = dvId.substring(0, dvId.lastIndexOf('$'));

    var upnlID = sender._postBackSettings.panelsToUpdate[0]; //sender._postBackSettings.panelID.split('|')[0];
