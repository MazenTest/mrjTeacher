...
public partial class GUI_TeacherPages_CommnetsManagement : TeacherBasePage
{
    ...
    private void GetAllComments()
    {
        ...
        {
            List<Comment> allComment = BLL.GetCommentsByTeacherId(Convert.ToInt32(Session["TeacherId"]));
