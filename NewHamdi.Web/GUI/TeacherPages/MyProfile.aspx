<%@ Page Language="C#" MasterPageFile="TeachersMasterPage.master" AutoEventWireup="false"
    CodeFile="MyProfile.aspx.cs" Inherits="GUI_TeacherPages_MyProfile" Title="ملفي الشخصي" %>
    ...
    <asp:UpdatePanel ID="upnlMyProfile" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table width="100%" cellpadding="2" cellspacing="1">
                ...
                <tr>
                    <td>
                        <asp:Image runat="server" ID="imgTeacher" Width="120" Height="120" Visible="true"
                ...
                <tr>
                    ...
                    <td class="style12" colspan="2">
                        <asp:FileUpload ID="fupTeacherImage" runat="server" CssClass="textBox" />
                        <asp:RequiredFieldValidator ID="rfvTeacherImage" runat="server" ControlToValidate="fupTeacherImage"
                ...
                <tr>
                    ...
                    <td class="style12">
                        <asp:TextBox ID="txtTeacherFirstName" runat="server" CssClass="textBox"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvFirstName" runat="server" ControlToValidate="txtTeacherFirstName"
                            ValidationGroup="Update">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                        <asp:TextBox ID="txtTeacherLastName" runat="server" CssClass="textBox"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvTeacherLastName" runat="server" ControlToValidate="txtTeacherLastName"
                            ValidationGroup="Update">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                        ...
                        <asp:GridView ID="gvContents" runat="server" Width="94%" CellPadding="3" GridLines="Vertical"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hdnContentId" runat="server" Value='<%# DataBinder.Eval(Container,"DataItem.CONTENT_ID") %>' />
                                ...
                                <asp:TemplateField HeaderText="تحميل">
                                    <ItemTemplate>
                                        <a href="Download.aspx?Cid=<%#DataBinder.Eval(Container, "DataItem.CONTENT_ID")%>">
