...
public partial class GUI_PublicPages_UsefulInfoArchive : PublicBasePage
{
    ...
    void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            DataTable dtUsefulInfo = BLL.GetAllUsefulInfo();
            dlstAllUsefulInfo.DataSource = dtUsefulInfo;
