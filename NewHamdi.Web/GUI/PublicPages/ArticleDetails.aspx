<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="false"
    ValidateRequest="false" CodeFile="ArticleDetails.aspx.cs" Inherits="GUI_PublicPages_ArticleDetails"
    Title="" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align: center">
        <asp:Label ID="lblArticleTitle" runat="server" Text="" Font-Bold="true" Font-Size="X-Large"></asp:Label>
    </div>
    <div style="text-align: center;">
        <asp:Label ID="lblArticlePublishDate" runat="server" Text="" Font-Bold="true"></asp:Label>
    </div>
    <br />
    <br />
    <div id="dvArticleDetails" runat="server" style="text-align: center; width: 100%; overflow: hidden">
    </div>
                    ...
                    <tr>
                        <td style="text-align: right" class="style1" valign="top">
                            <asp:UpdatePanel ID="upnlAllComments" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:DataList ID="dlstArticleComments" runat="server" Style="text-align: right; margin: 0 auto"
