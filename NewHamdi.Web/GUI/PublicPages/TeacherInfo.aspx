<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="false"
    ValidateRequest="false" CodeFile="TeacherInfo.aspx.cs" Inherits="TeacherInfo"
            ...
            <table width="100%" cellpadding="2" cellspacing="1" dir="rtl">
                <tr>
                    <td class="headerTd" colspan="6">
                        <asp:Label ID="lblTeacherInfoTitle" runat="server" Text="" Font-Bold="true"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td class="style9">
                    ...
                    <td class="style10">
                        <asp:Label ID="lblTeacherName" runat="server" Text="" Font-Bold="true"></asp:Label>
                    </td>
                    <td>
                        <asp:Image runat="server" ID="imgTeacher" Width="120" Height="120" ImageUrl="~/GUI/images/Perosn.png" />
                    </td>
                </tr>
                <tr>
                    <td class="style7">
                    ...
                    <tr>
                        <td style="text-align: right" class="style1" valign="top">
                            <asp:UpdatePanel ID="upnlAllComments" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:DataList ID="dlstTeacherComments" runat="server" Style="text-align: right; margin: 0 auto"
