...
<body>
    ...
    <input type="hidden" runat="server" enableviewstate="false" id="hiddenActionData"
        name="hiddenActionData" />
    <!-- end hidden -->
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td style="width: 20">
                <asp:Image ID="Image1" runat="server" ImageUrl="../Load.ashx?type=image&file=openfolder.gif">
                </asp:Image>
            </td>
            ...
            <td>
                ...
                <asp:ImageButton ID="Copy" BorderWidth="1" runat="server" AlternateText="[[Copyfiles]]"
                    ImageUrl="../Load.ashx?type=image&file=Copy.gif" onMouseOver="CuteEditor_ColorPicker_ButtonOver(this);"
                    Visible="true" OnClick="Copy_Click" />
                <asp:ImageButton ID="Move" BorderWidth="1" runat="server" AlternateText="[[Movefiles]]"
                    ImageUrl="../Load.ashx?type=image&file=move.gif" onMouseOver="CuteEditor_ColorPicker_ButtonOver(this);"
                    Visible="true" OnClick="Move_Click" />
                <img style="display: none" src="../Load.ashx?type=image&file=zoom_in.gif" onclick="Zoom_In();"
                    alt="[[ZoomIn]]" class="dialogButton" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" />
                <img style="display: none" src="../Load.ashx?type=image&file=zoom_out.gif" onclick="Zoom_Out();"
                    alt="[[ZoomOut]]" class="dialogButton" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" />
                <img style="display: none" src="../Load.ashx?type=image&file=Actualsize.gif" onclick="Actualsize();"
                    alt="[[ActualSize]]" class="dialogButton" onmouseover="CuteEditor_ColorPicker_ButtonOver(this);" />
                <asp:ImageButton ID="NewTemplate" BorderWidth="1" runat="server" AlternateText="[[NewTemplate]]"
                    ImageUrl="../Load.ashx?type=image&file=newtemplate.gif" onMouseOver="CuteEditor_ColorPicker_ButtonOver(this);"
                    Visible="true" OnClick="NewTemplate_Click" />
            </td>
        </tr>
    </table>
    <table border="0" cellspacing="0" cellpadding="2" width="100%">
        <tr>
            <td valign="top" style="white-space: nowrap; width: 250">
                <div style="border: 1.5pt inset; vertical-align: middle; overflow: auto; width: 250px;
                    height: 240px; padding: 0; background-color: white">
            ...
            <td valign="top">
                <div style="border: 1.5pt inset; vertical-align: top; overflow: auto; width: 380px;
        ...
        <tr>
            ...
            <td valign="top">
                ...
                <fieldset id="fieldsetUpload">
                    <legend>[[Upload]] ([[MaxFileSizeAllowed]]
                    ...
                    <table border="0" cellspacing="2" cellpadding="0" width="98%" class="normal">
                        ...
                        <tr>
                            <td style="white-space: nowrap">
                                ...
                                <span style="background-color: green; height: 3px; width: 40px; font-size: 3px"><span
                                    style="background-color: red; height: 3px; width: <%= GetUsedSpaceBarWidth() %>px;
                                    font-size: 3px"></span></span>
                            </td>
                        </tr>
                    </table>
                </fieldset>
